...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.getElementById('cadastro-form'); // ID do formulário de cadastro
    if (form) {
...
function sendFormData() {
    // Obtenha os valores preenchidos pelo usuário
    const formData = {
...
document.getElementById('stairForm').addEventListener('submit', async function(event) {
    event.preventDefault();
    
    const formData = {
        stairType: document.getElementById('stairType').value,
        stairLocation: document.getElementById('stairLocation').value,
        railingType: document.getElementById('railingType').value,
        treadType: document.getElementById('treadType').value,
        name: document.getElementById('name').value,
        email: document.getElementById('email').value,
        phone: document.getElementById('phone').value
    };
